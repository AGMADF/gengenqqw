...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' -help',`Im on ${client.guilds.size} servers`,`i help ${client.users.size} Members`,' AquaArab Support','Just Do It'];
    var i = -1;
    var j = 0;
...
client.on('message', message => {    
  ...
  client.on("message", function(message) {
   ...
   if(message.content.startsWith(prefix + "help")) {
    ...
    .setAuthor(message.author.username)
    .setThumbnail(message.author.avatarURL)
    .addField("Puplic | اوامر عامة","👥",true)
    .addField("Admin | اوامر الادارة","👑",true)
    .addField("Games | اوامر العاب","🎮",true)
     .addField("BotRooms | رومات البوت","🤖",true)
     .addField("Soon |اوامر الموسيقى","🔐🎵",true)
     .addField("Soon |اوامر الحماية","🔐",true)
    message.channel.send(RpsEmbed).then(msg => {
        msg.react('👥')
        msg.react("👑")
        msg.react("🎮")
...
let reaction5 = msg.createReactionCollector(reaction5Filter, { time: 18000 });
let reaction6 = msg.createReactionCollector(reaction6Filter, { time: 18000 });
reaction1.on("collect", r => {
  const embed = new Discord.RichEmbed()
...
『-sup ====> عرض سيرفر صاحب البوت
『-inv ====> لدعوة البوت الى سيرفرك
『 By ====> ! ᵀᴺ ~ 𝐿 𝑈 𝐶 𝐼 𝐹 𝐸 𝑅#3534
...
『-ebc ====> رسالة لجميع اعضاء السيرفر اونلاين
...
.setAuthor(message.author.username)
.setColor("#9B59B6")
.addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/5zpffb3**")
...
.setAuthor(message.author.username)
.setColor("#9B59B6")
.addField(" Done | https://discord.com/api/oauth2/authorize?client_id=748163906375254046&permissions=8&scope=bot" , " |  تم ارسال رابط البوت في الخاص")
